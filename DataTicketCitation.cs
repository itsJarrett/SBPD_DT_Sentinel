    ...
    public class DataTicketCitation
    {
        ...
        public geoZone GetGeoZone()
        {
            ...
            using (WebClient wc = new WebClient())
            {
                ...
                var json = wc.DownloadString("http://dev.virtualearth.net/REST/V1/Routes/Walking?wp.0=" + bingLocation + "&wp.1=" + "215 Main St, Seal Beach CA 90740" + "&key=");
                ...
                json = wc.DownloadString("http://dev.virtualearth.net/REST/V1/Routes/Walking?wp.0=" + bingLocation + "&wp.1=" + "13900 Seal Beach Blvd, Seal Beach CA 90740" + "&key=");
                ...
                json = wc.DownloadString("http://dev.virtualearth.net/REST/V1/Routes/Walking?wp.0=" + bingLocation + "&wp.1=" + "1430 Catalina Ave, Seal Beach CA 90740" + "&key=");
                jsonObj = JsonConvert.DeserializeObject(json);
                travelDistance = jsonObj.resourceSets[0].resources[0].travelDistance;
